...
//#region node_modules/.nitro/vite/services/ssr/assets/router--nHpIkTO.js
var router__nHpIkTO_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BEM7paRl.css";
var APP_NAME = "XO";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Play XO against a sharp AI. Choose X or O, or mix marks each round."
			},
			{
				name: "theme-color",
				content: "#0c100e"
...
var $$splitComponentImporter = () => import("./routes-CFh15Ruq.mjs");
...
//#endregion
export { getRouter, router__nHpIkTO_exports as t };
